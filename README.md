...
| **USB Host** | 🟨 WIP | 5V output not feeding to devices, investigating |
...
| **Battery / Charger** | 🟨 WIP | PM8550B + Southchip `sc8547-slave` / `sc8547a` (SuperVOOC)<br>Out of the box qcom-battmgr driver already feeding power to the battery. 5V 2A is possible already. |
